...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{images/chapt_5/ILC/ref_signal_ILC3.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{images/chapt_5/ILC/pi_to_ilc_fc_34.pdf}
...
\\Behavior of the system for a cut off frequency set to $f_c=25\,Hz$ is similar to behavior with $f_c=34\,Hz$, as shown in \figurename~\ref{fig:pi_to_ilc_fc_25}.
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{images/chapt_5/ILC/pi_to_ilc_fc_25.pdf}
...
\begin{equation}
  RMSE_{PI}=RMSE(1)\approx 0.8882\,l/min
\end{equation}
